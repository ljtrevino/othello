...
public void playerTurn(Graphics g){
	...
	g.drawString("Turn: " + turn, width/2-35, 120); //Font Characteristics for "Turn: __"
	
	g.setFont(new Font("SansSerif", Font.BOLD, 40));
	if(turn % 2 == 0){
		setBackground(new Color(30,144,255));
		g.setColor(Color.BLACK);
		g.drawString("Black's Turn", 95, 200);
	}
	else{
		setBackground(new Color(135,206,250));
		g.setColor(Color.WHITE);
		g.drawString("White's Turn", 1105, 200);
	}
...
g2D.setColor(new Color(0, 115, 0));
	...
	g.setFont(new Font("SansSerif", Font.BOLD, 40));
	g.setColor(Color.WHITE);
	g.drawString("OTHELLO",width/2-95, 800);
	setBackground(new Color(30,144,255));
